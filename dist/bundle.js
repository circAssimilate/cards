...
/******/ 	__webpack_require__.p = "/Users/dhammond/Development/cards/public";
/******/
...
var Cards = {
  TWO: {
    ...
    rank: [3],
    value: 5,
    decks: [Decks.STANDARD, Decks.STANDARD_JOKER],
...
var _fns = __webpack_require__(28);
...
window.deal = _fns2.default.shuffle();
console.log(deal);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('textarea', { id: 'output', placeholder: 'Press the button to generate', disabled: 'disabled' })
      );
    }
  }]);
...
var shuffle = function shuffle() {
  var deckType = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _constants2.default.Decks.STANDARD;

  var deck = [];
  var cards = _constants2.default.Cards;
  var cardKeys = Object.keys(cards);
  var suits = _constants2.default.Suits;
  var suitKeys = Object.keys(suits);

  cardKeys.forEach(function (cardValue, cardIndex) {
    switch (deckType) {
      // works
      case _constants2.default.Decks.STANDARD:
      case _constants2.default.Decks.STANDARD_JOKER:
        if (_constants2.default.Cards[cardValue].decks.includes(deckType)) {
          suitKeys.forEach(function (suitValue, suitIndex) {
            var suit = _constants2.default.Suits[suitValue];
            if (_constants2.default.Cards[cardValue].suits.includes(suit)) {
              var preferredName = _constants2.default.Cards[cardValue].preferredName || _constants2.default.Cards[cardValue].name;
              var suitName = _constants2.default.Suits[suitValue].name;
              if (suit.standard) {
